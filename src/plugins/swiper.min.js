    ...
    t = function(e, i) {
      ...
      function p(e) {
        ...
        if (!(e.shiftKey || e.altKey || e.ctrlKey || e.metaKey || (document.activeElement && document.activeElement.nodeName && ('input' === document.activeElement.nodeName.toLowerCase() || 'textarea' === document.activeElement.nodeName.toLowerCase())))) {
          ...
          b.isHorizontal()
            ? ((37 !== a && 39 !== a) || (e.preventDefault ? e.preventDefault() : (e.returnValue = !1)), ((39 === a && !b.rtl) || (37 === a && b.rtl)) && b.slideNext(), ((37 === a && !b.rtl) || (39 === a && b.rtl)) && b.slidePrev())
      ...
      if (
        ...
        ;(b.container[0].swiper = b),
          ...
          'cube' === b.params.effect &&
            ((b.params.resistanceRatio = 0), (b.params.slidesPerView = 1), (b.params.slidesPerColumn = 1), (b.params.slidesPerGroup = 1), (b.params.centeredSlides = !1), (b.params.spaceBetween = 0), (b.params.virtualTranslate = !0), (b.params.setWrapperSize = !1)),
          ('fade' !== b.params.effect && 'flip' !== b.params.effect) ||
            ((b.params.slidesPerView = 1), (b.params.slidesPerColumn = 1), (b.params.slidesPerGroup = 1), (b.params.watchSlidesProgress = !0), (b.params.spaceBetween = 0), (b.params.setWrapperSize = !1), 'undefined' == typeof f && (b.params.virtualTranslate = !0)),
          ...
          (b.params.nextButton || b.params.prevButton) &&
            (b.params.nextButton &&
              ((b.nextButton = a(b.params.nextButton)), b.params.uniqueNavElements && 'string' == typeof b.params.nextButton && b.nextButton.length > 1 && 1 === b.container.find(b.params.nextButton).length && (b.nextButton = b.container.find(b.params.nextButton))),
            b.params.prevButton &&
              ((b.prevButton = a(b.params.prevButton)), b.params.uniqueNavElements && 'string' == typeof b.params.prevButton && b.prevButton.length > 1 && 1 === b.container.find(b.params.prevButton).length && (b.prevButton = b.container.find(b.params.prevButton)))),
          ...
          (b.updateSlidesSize = function() {
            ...
            if ('undefined' != typeof b.size) {
              ...
              b.params.slidesPerColumn > 1 &&
                ((n = Math.floor(b.slides.length / b.params.slidesPerColumn) === b.slides.length / b.params.slidesPerColumn ? b.slides.length : Math.ceil(b.slides.length / b.params.slidesPerColumn) * b.params.slidesPerColumn),
              ...
              for (e = 0; e < b.slides.length; e++) {
                ...
                'none' !== u.css('display') &&
                  ('auto' === b.params.slidesPerView
                    ...
                    : ((o = (b.size - (b.params.slidesPerView - 1) * a) / b.params.slidesPerView), b.params.roundLengths && (o = r(o)), b.isHorizontal() ? (b.slides[e].style.width = o + 'px') : (b.slides[e].style.height = o + 'px')),
              ...
              if (
                ...
                (b.support.flexbox && !b.params.setWrapperSize) || (b.isHorizontal() ? b.wrapper.css({ width: b.virtualSize + b.params.spaceBetween + 'px' }) : b.wrapper.css({ height: b.virtualSize + b.params.spaceBetween + 'px' })),
                b.params.slidesPerColumn > 1 &&
          ...
          (b.updateClasses = function() {
            ...
            if (
              ...
              i.loop &&
                (t.hasClass(b.params.slideDuplicateClass)
                  ? b.wrapper.children('.' + b.params.slideClass + ':not(.' + b.params.slideDuplicateClass + ')[data-swiper-slide-index="' + t.attr('data-swiper-slide-index') + '"]').addClass(b.params.slideDuplicateNextClass)
                ...
                s.hasClass(b.params.slideDuplicateClass)
                  ? b.wrapper.children('.' + b.params.slideClass + ':not(.' + b.params.slideDuplicateClass + ')[data-swiper-slide-index="' + s.attr('data-swiper-slide-index') + '"]').addClass(b.params.slideDuplicatePrevClass)
              ...
              if (
                (b.params.loop
                  ? ((r = Math.ceil((b.activeIndex - b.loopedSlides) / b.params.slidesPerGroup)), r > b.slides.length - 1 - 2 * b.loopedSlides && (r -= b.slides.length - 2 * b.loopedSlides), r > n - 1 && (r -= n), r < 0 && 'bullets' !== b.params.paginationType && (r = n + r))
                ...
                'fraction' === b.params.paginationType && (b.paginationContainer.find('.' + b.params.paginationCurrentClass).text(r + 1), b.paginationContainer.find('.' + b.params.paginationTotalClass).text(n)),
            ...
            b.params.loop ||
              (b.params.prevButton &&
                ...
                (b.isBeginning ? (b.prevButton.addClass(b.params.buttonDisabledClass), b.params.a11y && b.a11y && b.a11y.disable(b.prevButton)) : (b.prevButton.removeClass(b.params.buttonDisabledClass), b.params.a11y && b.a11y && b.a11y.enable(b.prevButton))),
              b.params.nextButton &&
                b.nextButton &&
                b.nextButton.length > 0 &&
                (b.isEnd ? (b.nextButton.addClass(b.params.buttonDisabledClass), b.params.a11y && b.a11y && b.a11y.disable(b.nextButton)) : (b.nextButton.removeClass(b.params.buttonDisabledClass), b.params.a11y && b.a11y && b.a11y.enable(b.nextButton))))
          }),
              ...
              if ((b.updateContainerSize(), b.updateSlidesSize(), b.updateProgress(), b.updatePagination(), b.updateClasses(), b.params.scrollbar && b.scrollbar && b.scrollbar.set(), e)) {
                ...
                b.controller && b.controller.spline && (b.controller.spline = void 0),
                  b.params.freeMode
                    ...
                    : ((t = ('auto' === b.params.slidesPerView || b.params.slidesPerView > 1) && b.isEnd && !b.params.centeredSlides ? b.slideTo(b.slides.length - 1, 0, !1, !0) : b.slideTo(b.activeIndex, 0, !1, !0)), t || a())
          ...
          window.navigator.pointerEnabled ? (b.touchEventsDesktop = { start: 'pointerdown', move: 'pointermove', end: 'pointerup' }) : window.navigator.msPointerEnabled && (b.touchEventsDesktop = { start: 'MSPointerDown', move: 'MSPointerMove', end: 'MSPointerUp' }),
          (b.touchEvents = {
          ...
          if ((e.originalEvent && (e = e.originalEvent), (Y = 'touchstart' === e.type), Y || !('which' in e) || 3 !== e.which)) {
            ...
            if (!b.params.swipeHandler || o(e, b.params.swipeHandler)) {
              ...
              if (!(b.device.ios && b.params.iOSEdgeSwipeDetection && t <= b.params.iOSEdgeSwipeThreshold)) {
                if (
                  ((C = !0), (z = !1), (M = !0), (P = void 0), (A = void 0), (b.touches.startX = t), (b.touches.startY = s), (E = Date.now()), (b.allowClick = !0), b.updateContainerSize(), (b.swipeDirection = void 0), b.params.threshold > 0 && (L = !1), 'touchstart' !== e.type)
                ) {
                  var i = !0
              ...
              if ((M && b.emit('onTouchMove', b, e), !(e.targetTouches && e.targetTouches.length > 1))) {
                if (((b.touches.currentX = 'touchmove' === e.type ? e.targetTouches[0].pageX : e.pageX), (b.touches.currentY = 'touchmove' === e.type ? e.targetTouches[0].pageY : e.pageY), 'undefined' == typeof P)) {
                  ...
                  ;(b.isHorizontal() && b.touches.currentY === b.touches.startY) || (!b.isHorizontal() && b.touches.currentX === b.touches.startX)
                    ? (P = !1)
                    : ((t = (180 * Math.atan2(Math.abs(b.touches.currentY - b.touches.startY), Math.abs(b.touches.currentX - b.touches.startX))) / Math.PI), (P = b.isHorizontal() ? t > b.params.touchAngle : 90 - t > b.params.touchAngle))
                }
                if ((P && b.emit('onTouchMoveOpposite', b, e), 'undefined' == typeof A && b.browser.ieTouch && ((b.touches.currentX === b.touches.startX && b.touches.currentY === b.touches.startY) || (A = !0)), C)) {
                  ...
                  if (A || !b.browser.ieTouch) {
                    ...
                    b.params.followFinger &&
                      ...
                      b.params.freeMode && (0 === X.length && X.push({ position: b.touches[b.isHorizontal() ? 'startX' : 'startY'], time: E }), X.push({ position: b.touches[b.isHorizontal() ? 'currentX' : 'currentY'], time: new window.Date().getTime() })),
                      b.updateProgress(I),
                      b.setWrapperTranslate(I))
                  }
                }
          ...
          (b.effects = {
            ...
            cube: {
              setTranslate: function() {
                ...
                if (
                  (b.wrapper.css({ '-webkit-transform-origin': '50% 50% -' + b.size / 2 + 'px', '-moz-transform-origin': '50% 50% -' + b.size / 2 + 'px', '-ms-transform-origin': '50% 50% -' + b.size / 2 + 'px', 'transform-origin': '50% 50% -' + b.size / 2 + 'px' }),
                  b.params.cube.shadow)
                )
                  ...
                  0 !== i.length &&
                    i.each(function() {
                      ...
                      b.loadImage(e[0], r || i, n, o, !1, function() {
                        if (
                          (i ? (e.css('background-image', 'url("' + i + '")'), e.removeAttr('data-background')) : (n && (e.attr('srcset', n), e.removeAttr('data-srcset')), o && (e.attr('sizes', o), e.removeAttr('data-sizes')), r && (e.attr('src', r), e.removeAttr('data-src'))),
          ...
          (b.zoom = {
            ...
            onTouchStart: function(e, a) {
              ...
              t.gesture.image &&
                ...
                (t.image.isTouched ||
                  ('android' === e.device.os && a.preventDefault(), (t.image.isTouched = !0), (t.image.touchesStart.x = 'touchstart' === a.type ? a.targetTouches[0].pageX : a.pageX), (t.image.touchesStart.y = 'touchstart' === a.type ? a.targetTouches[0].pageY : a.pageY)))
            },
            ...
            toggleZoom: function(e, t) {
              var s = e.zoom
              if (
                (s.gesture.slide || ((s.gesture.slide = e.clickedSlide ? a(e.clickedSlide) : e.slides.eq(e.activeIndex)), (s.gesture.image = s.gesture.slide.find('img, svg, canvas')), (s.gesture.imageWrap = s.gesture.image.parent('.' + e.params.zoomContainerClass))),
            ...
            attachEvents: function(e) {
              ...
              if (b.params.zoom) {
                ...
                b.support.gestures
                  ...
                  : 'touchstart' === b.touchEvents.start && (b.slides[t](b.touchEvents.start, b.zoom.onGestureStart, s), b.slides[t](b.touchEvents.move, b.zoom.onGestureChange, s), b.slides[t](b.touchEvents.end, b.zoom.onGestureEnd, s)),
