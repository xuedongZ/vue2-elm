 ...
 * 获取首页热门城市
 */
// const hotcity = () => fetch('GET', '/v1/cities', {type: 'hot'})	// const hotcity = () => fetch('GET', '/v1/cities', {type: 'hot'})

/**
 * 获取首页所有城市
 */
// const groupcity = () => fetch('GET', '/v1/cities', {type: 'group'})	// const groupcity = () => fetch('GET', '/v1/cities', {type: 'group'})
